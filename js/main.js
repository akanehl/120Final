...
// Setup the example
    create:function() {
        ...
        PinkWall = Pwalls.create(300, 350,'atlas', 'PinkWall');
...
// The update() method is called every frame
    update:function() {
        ...
        var hitCoins=game.physics.arcade.overlap(player, Coin, collectCoin, null, this);
        ...
        //game.physics.arcade.overlap(Coins, Walllayer, respawnCoin, null, this);        
        ...
        /*
        function addCamera(){
            var camera = cameras.create(game.rnd.integerInRange(150, 900),game.rnd.integerInRange(150, 700),'atlas', 'Coin')            game.add.existing(guard);
            guards.add(guard);
        }
        */
